...
public class AbacEnvironmentConfiguration : IEntityTypeConfiguration<AbacEnvironment>
{
    public void Configure(EntityTypeBuilder<AbacEnvironment> entity)
    {
        entity.ToTable("abac_environments");
